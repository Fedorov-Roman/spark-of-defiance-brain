# Leonardo Prompts Ready

Готовые промпты для копирования. Не забудь: Model, Style, Size, Negative Prompt.
...
```
**Настройки:** Phoenix 1.0, Portrait, 2:3, Medium 1024×1024, Tiling OFF
...
```
**Настройки:** Phoenix 1.0, Portrait, 1:1, Medium 1024×1024

## 3. Страж SUN
```
Heavily armored humanoid soldier, white and chrome solar armor with sun emblem helmet, faceless visor glowing blue, tall imposing figure, sci-fi military, standing guard posture, dark industrial background, clean digital painting, game enemy concept, full body, dramatic lighting
```
**Настройки:** Phoenix 1.0, Portrait, 2:3, Medium 1024×1024
...
```
**Настройки:** Cinematic Kino, Cinematic, 16:9, Medium 1024×1024

## 5. Полярный Оазис (фон)
```
Cinematic alien polar landscape, frozen ice lake with neon blue glowing trees, crashed metal spaceship wreck, sci-fi outpost buildings in distance, aurora borealis in sky, cold blue and purple palette with orange accents, atmospheric perspective, game background art, 2D platformer style, painterly digital art, no characters, no text
```
**Настройки:** Cinematic Kino, Cinematic, 16:9, Medium 1024×1024

## 6. Глубинные Лаборатории (фон)
```
Cinematic dark sci-fi underground ruins, ancient alien technology with glowing purple bioluminescence, massive metal structures, overgrown with strange vines, mysterious fog, deep green and purple palette, atmospheric perspective, game background art, 2D platformer style, painterly digital art, no characters, no text
```
**Настройки:** Cinematic Kino, Moody, 16:9, Medium 1024×1024

## 7. Иконка «Кинжал Времени»
```
...
```
**Настройки:** Graphic Design, Vibrant, 1:1, Small 896×896

## 8. Текстура ржавого металла (seamless)
```
...
```
**Настройки:** Concept Art, None, 1:1, Small 896×896, Tiling ON

## 9. Песчаный Левиафан (босс)
```
...
```
**Настройки:** Cinematic Kino, Cinematic Concept, 16:9, Medium 1024×1024

## 10. Хаб «Искра» (фон)
```
Cinematic sci-fi rebel base interior, warm orange lighting, industrial metal walls with graffiti and posters, workbenches with tools and weapons, small glowing screens, cozy but rugged atmosphere, underground hideout, game background art, 2D platformer style, painterly digital art, no characters, no text
```
**Настройки:** Concept Art, Moody, 16:9, Medium 1024×1024

## Negative Prompt (универсальный)
```
blurry, low quality, deformed hands, extra fingers, watermark, text, logo, cropped, anime, cartoon, 3D render, stock photo, photorealistic, deformed face
```
